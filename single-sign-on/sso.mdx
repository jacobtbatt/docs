...
<Steps>
  <Step title="Client Information">
    ...
    | Entity ID                                                                                                                        | urn:auth0:thnks:<Tooltip tip="yourConnectionName is provided by Thnks and will always be the name of your company.  If you feel comfortable completing without a Thnks Team member then please respond to sso@thnks.com with yourConnectionName (case sensitive) and your X.509 Signing Certificate">yourConnectionName</Tooltip> |

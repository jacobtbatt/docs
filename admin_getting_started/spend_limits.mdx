...
* Click "Admin" at the top right corner of the page
  <img
...
* On the left, click "Spend Limits"
  * <img
    className="block dark:hidden"
...
* Hit "Set user spend targets" and you can set individual spend targets for each of your team users that will reset each month on the 1st

---
title: "Quick Install"
description: "Get up and running with Thnks v1.9 in minutes. This streamlined guide covers the essential steps for new installations."
---
...
<Note>
  **As of v1.8**: Users must have matching email addresses between their Thnks and Salesforce accounts to use the "Send Thnks" feature within Salesforce.
</Note>
...
Contact your Thnks Account Manager or [integrations@thnks.com](mailto:integrations@thnks.com) to:
...
1. Contact your Thnks Account Manager or [integrations@thnks.com](mailto:integrations@thnks.com) to get your Organization Token
...
### Step 6: Add the Send Thnks Flow Action (Optional, new in v1.9)

For teams that want to trigger Thnks sends from Salesforce Flow automation, no Thnks Request record required:

1. Open **Flow Builder** and go to the Flow you want to add the action to
2. In the Action picker, search for **"Send Thnks"**
3. Confirm the running user has the **Thnks Admin** or **Thnks Standard User** permission set assigned, otherwise the action won't appear
4. Configure the required inputs: **Gift Id**, **Sender Email**, **Recipient Email**
5. Optionally set **Recipient First/Last Name**, **Recipient Message**, **Include Carbon Neutral Cost**, **UTM Campaign Id**, and **Source Record Id**
...
- Review the [Install Guide](https://docs.thnks.com/appexchange/install) for detailed configuration options

- Set up [custom field mapping](https://docs.thnks.com/appexchange/install#fields-mapping) for ROI tracking
- Train users on the new Send Thnks functionality

## Support

Need help? Contact us at [integrations@thnks.com](mailto:integrations@thnks.com) or reach out to your Thnks Account Manager.

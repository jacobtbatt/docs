...
**New in v1.9**, Thnks Request flows enable you to automatically trigger Thnks based on business events in Salesforce. This powerful feature allows you to create sophisticated automation for marketing campaigns, sales cadences, and customer success workflows.
